    ...
    <div className="space-y-5 rounded-xl border border-border bg-card p-5 shadow-sm">
      ...
      <ReadonlySection title="Primary bank details">
        <ReadonlyGrid>
          ...
          <ReadonlyField label="Branch location" value={employee.primaryBankBranchLocation} />
        </ReadonlyGrid>
      </ReadonlySection>
      ...
      <ReadonlySection title="Secondary bank details">
        <ReadonlyGrid>
          ...
          <ReadonlyField label="Branch location" value={employee.secondaryBankBranchLocation} />
        </ReadonlyGrid>
      </ReadonlySection>
